...
public abstract class AbstractDatabaseTest {
  ...
  protected String getTempTableName(int tableNamePrefix, String tableName) {
    return TempTables.getTempTableName(tableNamePrefix, tableName);
  }


  protected String getTempUnaryTableName(int tableNamePrefix, String tableName) {
    return TempTables.getTempUnaryTableName(tableNamePrefix, tableName);
  }

  protected Records select(String table) {
    try {
  ...
  protected Records select(String table, String... fields) {
  ...
  protected Map<String, String> assertPresent(Optional<Map<String, String>> optRecord) {
