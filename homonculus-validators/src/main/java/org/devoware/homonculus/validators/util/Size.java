package org.devoware.homonculus.validators.util;
...
public class Size implements Comparable<Size> {
  ...
  private static final ImmutableSortedMap<String, SizeUnit> SUFFIXES =
      ImmutableSortedMap.<String, SizeUnit>orderedBy(String.CASE_INSENSITIVE_ORDER)
