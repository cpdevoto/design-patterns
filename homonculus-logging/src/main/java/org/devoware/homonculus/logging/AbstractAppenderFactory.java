...
import org.devoware.homonculus.logging.filter.FilterFactory;
 ...
 * <td>{@code timeZone}</td>
 * <td>{@code UTC}</td>
 * <td>The time zone to which event timestamps will be converted. Ignored if logFormat is supplied.
 * </td>
 * </tr>
 * <tr>
 ...
 * <td>{@link AsyncAppenderBase}</td>
 * <td>Whether to include caller data, required for line numbers. Beware, is considered expensive.
 * </td>
 * </tr>
 * <tr>
 * <td>{@code discardingThreshold}</td>
 * <td>{@link AsyncAppenderBase}</td>
 * <td>By default, when the blocking queue has 20% capacity remaining, it will drop events of level
 * TRACE, DEBUG and INFO, keeping only events of level WARN and ERROR. To keep all events, set
 * discardingThreshold to 0.</td>
 * </tr>
 * <tr>
 * <td>{@code filterFactories}</td>
 * <td>(none)</td>
 * <td>A list of {@link FilterFactory filters} to apply to the appender, in order, after the
 * {@code threshold}.</td>
 * </tr>
 * </table>
 */
public abstract class AbstractAppenderFactory<E extends DeferredProcessingAware>
  ...
  public void setLayout(DiscoverableLayoutFactory layout) {
    this.layout = layout;
  }
  ...
  protected LayoutBase<E> buildLayout(LoggerContext context,
