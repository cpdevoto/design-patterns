...
public class CustomerCloneAssertions {

  private final AbstractDatabaseTest test;
  private int acTags;

  public CustomerCloneAssertions(AbstractDatabaseTest test, int acTags) {
  ...
  public void assertStateAfterClone(Optional<Integer> prefix) {
    ...
    assertRecord(record)
        .hasFieldValue("id", 2)
        .hasFieldValue("distributor_id", 2)
