package org.devoware.homonculus.core.util;
...
public class Generics {
  ...
  public static <T> Class<T> getTypeParameter(Class<?> klass, Class<? super T> bound) {
    ...
    /*
     * This is not guaranteed to work for all cases with convoluted piping of type parameters: but
     * it can at least resolve straight-forward extension with single type parameter (as per
     * [Issue-89]). And when it fails to do that, will indicate with specific exception.
     */
