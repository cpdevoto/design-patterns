...
public class ExecutorServiceBuilder {
    ...
    public ExecutorServiceBuilder(Environment environment, String nameFormat, ThreadFactory factory) {
    ...
    public ExecutorServiceBuilder(Environment environment, String nameFormat) {
